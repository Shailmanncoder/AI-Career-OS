...
export const resumeRewriteSchema = z.object({
  fullName: requiredText(120, "Your Name"),
  ...
  keywordsAdded: stringList.default([]),
  placeholders: stringList.default([]),
  changeNotes: stringList.default([]),
});

export type ResumeRewritePayload = z.infer<typeof resumeRewriteSchema>;
